...
# Updated by: David Fonseca
#
#
# Import the tkinter module and create window called root
# Change the title of the root window to "Simple Calculator"
from tkinter import *
...
# Create an entry box into the root window. Set Width and borderwidth.
